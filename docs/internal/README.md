...
- Keep internal docs technical and structured.
- Treat mechanics docs as source-of-truth for implementation intent.
- Mark uncertain/changing systems explicitly as `Provisional`.
